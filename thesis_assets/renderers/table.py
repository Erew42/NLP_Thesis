...
_HEADER_LABELS = {
    ...
    "lm_vs_abnormal_volume": "L--M vs abn. volume",
    "lm_vs_postevent_volatility": "L--M vs postevent vol.",
    ...
    "finbert_vs_abnormal_volume": "FinBERT vs abn. volume",
    "finbert_vs_postevent_volatility": "FinBERT vs postevent vol.",
