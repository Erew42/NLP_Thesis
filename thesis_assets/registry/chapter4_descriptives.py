...
ASSETS: tuple[AssetSpec, ...] = (
    AssetSpec(
        ...
        notes_stub="Rows report the stored LM2011 sample-selection ladder for the 1994-2008 replication window.",
    ...
    AssetSpec(
        ...
        notes_stub="Figure is generated from the stored LM2011 sample-creation ladder.",
        sample_contract_id="raw_available",
    ...
    AssetSpec(
        ...
        notes_stub="Observations removed are taken directly from the stored LM2011 attrition ladder.",
        sample_contract_id="raw_available",
    ...
    AssetSpec(
        ...
        notes_stub="Bridge stages are selected from canonical LM2011 sample-creation rows.",
        sample_contract_id="raw_available",
    ...
    AssetSpec(
        ...
        notes_stub="Definitions summarize reporting conventions, including the thesis portfolio Q1-Q5 presentation rule.",
