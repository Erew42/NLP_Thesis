...
ASSETS: tuple[AssetSpec, ...] = (
    ...
    AssetSpec(
        ...
        caption_stub="Chapter 5 fit comparison diagnostic for Item 7, filing-period excess returns, and control set C0.",
        notes_stub="Rows report stored fit-comparison outputs for the Item 7 C0 common-success sample without adding empirical interpretation.",
    ...
    AssetSpec(
        ...
        notes_stub=(
            "Rows report matched-only canonical cleaned-scope and FinBERT-visible-prefix "
            "coefficient estimates. Unmatched rows are reported in ch5_visible_prefix_match_diagnostics."
        ),
        ...
        table_display_columns=(
            ...
            "coefficient",
            "canonical_estimate",
            "visible_prefix_estimate",
            "estimate_delta",
            "canonical_t_stat",
            "visible_prefix_t_stat",
            "t_stat_delta",
            "canonical_n_obs",
            "visible_prefix_n_obs",
        ),
        write_full_appendix_table=True,
        table_display_note="Primary rendering uses a compact column set; full audit columns are written with the _full suffix.",
    ),
    AssetSpec(
        ...
        notes_stub=(
            "Rows report matched-only C0 adjusted-R2 summaries and fit-comparison deltas "
            "between canonical cleaned-scope and FinBERT-visible-prefix surfaces. "
            "Unmatched rows are reported in ch5_visible_prefix_match_diagnostics."
        ),
        ...
        table_display_columns=(
            ...
            "model_or_comparison",
            "canonical_weighted",
            "visible_prefix_weighted",
            "delta_weighted",
            "canonical_equal_quarter",
            "visible_prefix_equal_quarter",
            "delta_equal_quarter",
            "canonical_n_quarters",
            "visible_prefix_n_quarters",
        ),
        write_full_appendix_table=True,
        table_display_note="Primary rendering uses a compact column set; full audit columns are written with the _full suffix.",
    ),
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_visible_prefix_match_diagnostics",
        caption_stub="Visible-prefix matched-surface diagnostics.",
        notes_stub=(
            "Rows identify canonical-only and visible-prefix-only rows excluded from the matched-only "
            "coefficient and fit sensitivity tables."
        ),
        sample_contract_id="visible_prefix_match_diagnostics",
        builder_id="chapter5_visible_prefix_match_diagnostics",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="canonical_extension_results",
                run_family=RUN_FAMILY_LM2011_EXTENSION,
    ...
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_extension_c0_observed_scale_effects",
        caption_stub="Observed-scale C0 Item 1A and Item 7 extension effects.",
        notes_stub=(
            "Rows translate selected replication-family C0 filing-period excess-return coefficients "
            "into IQR-implied return effects using the retained regression support. Skipped quarters "
            "recorded in the extension fit diagnostics are excluded before computing score dispersion."
        ),
        sample_contract_id="observed_scale_extension_c0",
        builder_id="chapter5_extension_c0_observed_scale_effects",
        required_artifacts=(
            ArtifactRequirement(
    ...
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_lm2011_table_vi_volatility_observed_scale",
        caption_stub="Observed-scale Table VI postevent-volatility effects.",
        notes_stub=(
            "Rows translate selected no-ownership Table VI postevent-volatility coefficients into "
            "IQR-implied changes in residual volatility. Coefficients are on the table's x100 scale, "
            "so IQR effects are reported in percentage points."
        ),
        sample_contract_id="observed_scale_table_vi_volatility",
        builder_id="chapter5_lm2011_table_vi_volatility_observed_scale",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="table_vi_results_no_ownership",
                run_family=RUN_FAMILY_LM2011_POST_REFINITIV,
    ...
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_nw_lag_baseline_reconciliation",
        caption_stub="NW(1) sensitivity rerun reconciliation against current Chapter 5 source artifacts.",
        notes_stub="Rows compare the NW(1) sensitivity output with the stored thesis-source artifacts. Differences should be numerical noise.",
        sample_contract_id="nw_lag_baseline_reconciliation",
        builder_id="chapter5_nw_lag_baseline_reconciliation",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="core_tables_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
                artifact_key=ARTIFACT_KEY_NW_LAG_CORE_TABLES,
                required_columns=(
                    "stage_name",
                    "table_id",
                    "specification_id",
            ...
            ArtifactRequirement(
                logical_name="extension_results_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
                artifact_key=ARTIFACT_KEY_NW_LAG_EXTENSION_RESULTS,
                required_columns=(
                    "dictionary_family_source",
                    "text_scope",
                    "outcome_name",
            ...
            ArtifactRequirement(
                logical_name="extension_fit_comparisons_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
                artifact_key=ARTIFACT_KEY_NW_LAG_EXTENSION_FIT_COMPARISONS,
                required_columns=(
                    "dictionary_family_source",
                    "text_scope",
                    "outcome_name",
    ...
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_nw_lag_core_no_ownership_appendix",
        caption_stub="NW lag sensitivity for no-ownership LM2011 core Fama-MacBeth tables.",
        notes_stub="Rows report signal coefficients under NW(1)-NW(4). Return and volatility estimates are multiplied by 100; abnormal volume and SUE remain on the stored scale.",
        sample_contract_id="nw_lag_core_no_ownership",
        builder_id="chapter5_nw_lag_core_no_ownership_appendix",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="core_tables_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
        ...
        write_full_appendix_table=True,
        table_display_note="Primary rendering uses a compact NW lag column set; full audit columns are written with the _full suffix.",
    ),
    AssetSpec(
        asset_id="ch5_nw_lag_extension_coefficients_appendix",
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_nw_lag_extension_coefficients_appendix",
        caption_stub="NW lag sensitivity for matched dictionary-versus-FinBERT extension coefficients.",
        notes_stub="Rows report replication-dictionary Item 1A and Item 7 signal coefficients under NW(1)-NW(4). Filing-period return estimates are multiplied by 100.",
        sample_contract_id="nw_lag_extension_coefficients",
        builder_id="chapter5_nw_lag_extension_coefficients_appendix",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="extension_results_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
    ...
    AssetSpec(
        ...
        chapter="chapter5",
        asset_kind="table",
        output_stem="ch5_nw_lag_extension_fit_comparisons_appendix",
        caption_stub="NW lag sensitivity for extension adjusted-R2 fit comparisons.",
        notes_stub="Rows report adjusted-R2 deltas under NW(1)-NW(4). Fit deltas remain on the stored adjusted-R2 scale.",
        sample_contract_id="nw_lag_extension_fit_comparisons",
        builder_id="chapter5_nw_lag_extension_fit_comparisons_appendix",
        required_artifacts=(
            ArtifactRequirement(
                logical_name="extension_fit_comparisons_nw_lag_sensitivity",
                run_family=RUN_FAMILY_LM2011_NW_LAG_SENSITIVITY,
    ...
    AssetSpec(
        ...
        caption_stub="Chapter 5 Item 7 concordance on the matched common row sample.",
        notes_stub="Concordance figure uses the matched cleaned-scope sample only and does not mix surfaces.",
    ...
    AssetSpec(
        ...
        caption_stub="Document-level ECDFs of LM2011 negative dictionary scores, by weighting method.",
        notes_stub=(
            "ECDFs use replication-family cleaned-scope document scores for Item 7 and Item 1A. "
            "Proportion and tf-idf scores are shown in separate panels; the tf-idf panel includes the full observed tail."
        ),
    ...
    AssetSpec(
        ...
        notes_stub="ECDFs use cleaned-scope document scores for Item 7 and Item 1A.",
        sample_contract_id="raw_available",
    ...
    AssetSpec(
        ...
        notes_stub="Sentence-level ECDFs are binned summaries over the analysis-panel doc-scope universe.",
    ...
    AssetSpec(
        ...
        notes_stub="Sentence-level LM2011 scores are computed in batches from sentence text.",
        sample_contract_id="analysis_panel_sentence_scores",
    ...
    AssetSpec(
        ...
        notes_stub="High-negative shares use fixed thresholds and batch-combinable counts.",
        sample_contract_id="analysis_panel_sentence_scores",
    ...
    AssetSpec(
        ...
        notes_stub="Concordance uses matched replication-family cleaned-scope rows.",
        sample_contract_id="common_row_comparison",
    ...
    AssetSpec(
        ...
        write_full_appendix_table=True,
        table_display_note="Primary rendering uses a compact robustness column set; full audit columns are written with the _full suffix.",
    ),
    AssetSpec(
        ...
        write_full_appendix_table=True,
        table_display_note="Primary rendering uses a compact control-coefficient column set; full audit columns are written with the _full suffix.",
    ),
    AssetSpec(
